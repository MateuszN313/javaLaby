...
public class AccountManager {
    ...
    private void initializeTable(){
        try (PreparedStatement stmt = this.connection.prepareStatement("""
            ...
            System.err.println("Error at creating table: " + e.getMessage());
        }
    }
    ...
    public Account getAccount(String usernameOrId){
        try{
            ...
            if(isNumeric){
                stmt = this.connection.prepareStatement("SELECT * FROM accounts WHERE id = ?;");
                stmt.setInt(1,Integer.parseInt(usernameOrId));
            }else{
                stmt = this.connection.prepareStatement("SELECT * FROM accounts WHERE username = ?;");
            ...
            System.err.println("Getting account error: " + e.getMessage());
        }
        return null;
    }
}
